...
namespace LFAdminCoreProject.Services.Infrastructure
{
    public class ReturnMethod
    {
        ...
        {
            return new JsonResult(new { Code = 0, Msg = message, Data = data });
        }
        /// <summary>
        /// 返回失败
        /// </summary>
        ...
        { 
            return new JsonResult(new { Code = code, Msg = message, Data = data });
        }

        public static JsonResult ReturnWarning(int code, string message = "", object data = null)
        {
            Utility.Log4netHelper.Warning(message);
            return new JsonResult(new { Code = code, Msg = message, Data = data });
        }
        public static JsonResult ReturnInfo(int code, string message = "", object data = null)
        {
            Utility.Log4netHelper.Info(message);
            return new JsonResult(new { Code = code, Msg = message, Data = data });
        }
